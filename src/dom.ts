...
export function queryDom() {
  return {
    ...
    analysisClockGroup: el('analysis-clock-group'),
    analysisClockList: el('analysis-clock-list'),
    analysisClockEdges: el<HTMLInputElement>('analysis-clock-edges'),
    analysisClockStep: el<HTMLButtonElement>('analysis-clock-step'),
    analysisClockVerdict: el('analysis-clock-verdict'),
    analysisClockTable: el('analysis-clock-table'),
