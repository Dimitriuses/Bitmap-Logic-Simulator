...
- **Space is overloaded on purpose and safely**: while the keyboard cursor is *visible* it applies the tool, otherwise it pauses. The cursor being on screen is the signal.
